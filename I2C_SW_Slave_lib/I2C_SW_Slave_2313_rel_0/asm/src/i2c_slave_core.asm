/*
 * I2C Slave Core Service Code - ATtiny2313
 *
 * org: 02/23/2015
 * rev: 03/29/2015
...
; Get COMMAND
	...
	rcall	fifo_get				; XL, XH, r19 preserved.
	tst		r18						; valid data?
	breq	scs_skip01
	rjmp	scs_exit
scs_skip01:
...
// Core Command
	rcall	core_command_processor
	rjmp	scs_exit
;
scs_skip02:
// Board Command
;;;	rcall	board_command_processor		; --> i2c_slave_TBB.asm
	rjmp	scs_exit
;
scs_exit:
;
